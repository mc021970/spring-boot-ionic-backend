...
INSERT INTO `categoria` VALUES (1,'Informática'),(2,'Escritório'),(3,'Ferramentas'),(4,'Malas'),(5,'Acessórios'),(6,'Celulares'),(7,'Programas'),(8,'Móveis'),(9,'Limpeza'),(10,'Decoração');
...
INSERT INTO `cidade` VALUES (1,'São Paulo',26),(2,'Campinas',26),(3,'Santos',26),(4,'Araraquara',26),(5,'Belo Horizonte',11),(6,'Juiz de Fora',11),(7,'Três Corações',11),(8,'Uberlândia',11),(9,'Rio de Janeiro',19),(10,'Niterói',19),(11,'São Gonçalo',19),(12,'Nova Igauçu',19);
...
INSERT INTO `cliente` VALUES (1,'11111111111','jas@hotmail.com','José Antônio Santos',1);
...
INSERT INTO `endereco` VALUES (1,'Bairro 1','01111-001',NULL,'Rua Um','1',11,1),(2,'Bairro 2','02222-002',NULL,'Rua Dois','2',12,1);
...
INSERT INTO `item_pedido` VALUES (0,2599.99,1,1,1),(0.1,34.99,1,1,2),(0,24.99,2,1,3),(0.05,34.99,2,2,2);
...
INSERT INTO `pagamento_boleto` VALUES (NULL,'2021-03-13 18:39:21.409000',1);
...
INSERT INTO `pagamento_cartao` VALUES (5,2);
...
INSERT INTO `pedido` VALUES (1,'2021-03-12 18:39:21.409000',1,2),(2,'2021-03-12 16:39:21.409000',1,2);
...
INSERT INTO `produto` VALUES (1,'Computador Desktop completo','Computador',2599.99),(2,'Impressora jato de tinta','Impressora',34.99),(3,'Mouse ótico com fio, USB','Mouse',24.99),(4,'Monitor Full HD 22\'','Monitor 22\'',299.99),(5,'Cadeira de escritório com ajuste de altura e inclinação','Cadeira de Escritório',249.99),(6,'Mochila em couro para notebook e acessórios','Mochila Notebook',99.99),(7,'Luminária LED USB','Luminária LED USB',39.99);
...
INSERT INTO `produto_categoria` VALUES (1,1),(2,1),(2,2),(3,1),(4,1),(5,2),(5,8),(5,10),(6,4),(6,5),(6,1),(7,1),(7,5),(7,10);
...
INSERT INTO `telefone` VALUES (1,'(11) 99999-9999'),(1,'(11) 2323-2323');
...
-- Dump completed on 2021-03-12 21:25:19
